...
var Page = function (_React$Component) {
  ...
  _createClass(Page, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return !(this.props.pure && (0, _isEqual2.default)(this.props, nextProps) && (0, _isEqual2.default)(this.state, nextState));
    }
  }, {
...
Page.propTypes = {
  ...
  pure: _react2.default.PropTypes.bool.isRequired
};
Page.defaultProps = {
  pages: {},
  path: [],
