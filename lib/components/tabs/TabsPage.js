...
var TabsPage = function (_Page) {
  ...
  _createClass(TabsPage, [{
    ...
    value: function selectTab(key) {
      var newChildPageProps = (0, _cloneDeep2.default)(this.props.childPages);
      (0, _each2.default)(newChildPageProps, function (c) {
        c.selected = c.key === key;
        return true;
      });
      this.props.dispatch((0, _creators.setPageProps)(this.props.path, { childPages: newChildPageProps }));
    }
  }]);
