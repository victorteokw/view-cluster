...
var StackPage = function (_Page) {
  ...
  _createClass(StackPage, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.childPages.map(function (i, n, a) {
            return _react2.default.createElement(
              _StackView2.default,
              { key: i.key, first: n === 0, last: n === a.length - 1 },
              _this2.pageRender(i)
            );
          })
        )
    ...
    value: function getSelectedPageKey() {
      ...
      return (0, _last2.default)(this.props.childPages).key;
    }
  }, {
    ...
    value: function updateNavigationBar() {
      ...
      var keyArray = map(this.props.childPages, function (i) {
        return i.key;
      });
      var pageArray = map(keyArray, function (k) {
        return _this3.pages[k];
      });
      var itemsArray = map(pageArray, function (p) {
