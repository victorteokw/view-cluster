...
(0, _addPageAction2.default)('PUSH_STACK', function (props, action) {
  props.childPages.push(action.payload.page);
  return props;
});

function _pushStack(path, page) {
  return {
    type: 'PUSH_STACK',
    payload: {
      path: path,
...
(0, _addPageAction2.default)('POP_STACK', function (props, action) {
  props.childPages.pop();
  return props;
});

function _popStack(path) {
  return {
    type: 'POP_STACK',
    payload: {
      path: path
...
var StackPage = function (_Page) {
  ...
  _createClass(StackPage, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.childPages.map(function (i, n, a) {
            return _react2.default.createElement(
              _StackView2.default,
              { key: i.key, first: n === 0, last: n === a.length - 1, ref: function ref(r) {
    ...
    value: function pushStack(desc) {
      this.props.dispatch(_pushStack(this.props.path, desc));
    }
  }, {
    key: 'popStack',
    value: function popStack() {
      this.props.dispatch(_popStack(this.props.path));
    }
  }, {
    key: 'pureRender',
