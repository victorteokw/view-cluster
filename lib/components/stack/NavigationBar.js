...
var NavigationBar = function (_React$Component) {
  ...
  _createClass(NavigationBar, [{
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      ...
      if ((0, _isEqual2.default)(pureStack, dropRight(pureNextStack)) && !(0, _isEqual2.default)(pureStack, [])) {
        this.animate = 'push';
        this.topStackItem = this.dominantStackItem;
        this.bottomStackItem = (0, _last2.default)(this.state.stack);
      } else if ((0, _isEqual2.default)(dropRight(pureStack), pureNextStack)) {
        this.animate = 'pop';
    ...
    key: 'style',
    value: function style(className, index) {
      return {};
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('navigation-bar', this.animate, this.dominantStackItem ? this.dominantStackItem.variant : false) },
    ...
    value: function renderItemPartial(partial, className) {
      return _react2.default.createElement(
        ...
        { className: className, touchUpInside: partial.event || empty },
        partial.content,
