...
(0, _addPageAction2.default)(_types.PRESENT_MODAL, function (props, action) {
  props.childPages.push(action.payload.page);
  return props;
});

(0, _addPageAction2.default)(_types.DISMISS_MODAL, function (props, action) {
  props.childPages = (0, _filter2.default)(props.childPages, function (p) {
...
var ModalsPage = function (_Page) {
  ...
  _createClass(ModalsPage, [{
    ...
    value: function getSelectedPageKey() {
      ...
      if ((0, _last2.default)(props.childPages)) {
    ...
    value: function presentModal(props) {
      this.props.dispatch((0, _creators.presentModal)(this.props.path, props));
    }
  }, {
    key: 'dismissModal',
    value: function dismissModal(key) {
      this.props.dispatch((0, _creators.dismissModal)(this.props.path, key));
    }
  }]);
