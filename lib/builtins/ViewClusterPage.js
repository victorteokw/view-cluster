...
var ViewClusterPage = function (_Page) {
  ...
  _createClass(ViewClusterPage, [{
    ...
    value: function renderPage() {
      var rootPage = (0, _find2.default)(this.props.childPages, function (c) {
        return c.key === 'root';
      });
      var modalsPage = (0, _find2.default)(this.props.childPages, function (c) {
        return c.key === 'modals';
      });
    ...
    value: function getSelectedPageKey() {
      ...
      var modalsPage = (0, _find2.default)(props.childPages, function (c) {
        return c.key === 'modals';
      });
